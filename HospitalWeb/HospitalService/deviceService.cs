...
namespace HospitalService
{
    ...
    {
       public int AddNew(string device_ID, string device_name, string device_dept)
        {
        ...
        public DeviceDTO GetById(string id)
        {
            using (MyContext ctx = new MyContext())
            {
                ...
                var s = ctx.devices.AsNoTracking().Include(e=>e.device_dept)
